<div x-data="{ loading: true }" x-init="setTimeout(() => loading = false, 1000)" class="container mx-auto px-4 py-12 max-w-[10000px]">
    ...
    <!-- Repeat the same layout for Recommended Movies and Most Watched Movies -->
    <h2 class="text-3xl text-white text-center font-bold mt-8 mb-6">Recommended Movies</h2>
    ...
    <h2 class="text-3xl text-white text-center font-bold mt-8 mb-6">Most Watched Movies</h2>
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-5">
        ...
        <h2 class="text-3xl text-white text-center font-bold mb-6">Trending Movies</h2>
        <div x-show="!loading" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform scale-90" x-transition:enter-end="opacity-100 transform scale-100" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-5">
