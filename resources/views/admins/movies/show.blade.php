<div class="relative bg-primary text-white min-h-screen">
    ...
    <div class="absolute inset-0 opacity-10">
        <img src="{{ $movie->image }}" alt="{{ $movie->title }} backdrop" class="w-full h-full object-cover">
    </div>  
    ...
    <div class="relative z-10 container mx-auto px-4 md:px-8 lg:px-16 py-16 md:py-24">
        <div class="flex flex-col md:flex-row md:space-x-8">
            ...
            <div class="flex-grow md:pl-8">
                ...
                <p class="text-xl italic text-gray-400 mb-6">{{ $movie->category }}</p>

                <!-- Genres -->
                <div class="flex flex-wrap gap-4 mb-8">
                    <span class="px-4 py-2 bg-accent rounded-full text-sm font-semibold">{{ $movie->category }}</span>
                </div>
                ...
                <div class="flex items-center space-x-6 mb-10">
                    ...
                    <div class="w-20 h-20 bg-gray-900 rounded-full flex items-center justify-center relative">
                        ...
                        <span class="absolute text-white text-xl font-bold">{{ $movie->vote_average }}</span>
                    </div>
                    ...
                    <div x-data="{ showPopup: false }" class="relative">
                        ...
                        <div x-show="showPopup" @click.away="showPopup = false" class="fixed inset-0 z-50 flex items-center justify-center">
                            ...
                            <div class="bg-gray-900 rounded-lg shadow-lg z-10 relative w-4/5 h-4/5">
                                ...
                                <div class="w-full h-[calc(100%-40px)] flex items-center justify-center">
                                    <iframe class="w-full h-full" src="{{ $movie->video }}" frameborder="0" allowfullscreen></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
