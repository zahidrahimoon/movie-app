...
<body class="bg-primary font-playfair">
    <section class="flex flex-col md:flex-row h-screen">
        ...
        <div class="w-full md:w-2/3 bg-gray-800 dark:bg-gray-900 flex items-center justify-center">
            <img src="https://image.tmdb.org/t/p/original/b3mdmjYTEL70j7nuXATUAD9qgu4.jpg" alt="logo" class="w-full h-full object-cover">
        </div>
